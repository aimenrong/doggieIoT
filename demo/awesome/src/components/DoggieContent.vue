	...
	export default {
		...
		mounted() {
			...
			AMap.service('AMap.Geocoder',function(){
				...
				console.log("AMap.Geocoder load done...");
			});
			...
			map.plugin('AMap.Geolocation', function() {
				...
				console.log("AMap.Geolocation load done...");				
			});
			console.log("Call DoggieContent end...");
		},
		created() {
			console.log('Call DoggieContent created');
		...
		methods: {
			sendSubscription() {
				...
				mqttService.sendNotification(this.txtLongitude, this.txtLatitude, this.txtNotificationCnt);
				eventBus.$emit('onSubscriptionCreationAction', this.txtNotificationCnt);
